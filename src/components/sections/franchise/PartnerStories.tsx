...
/**
 * Partner Stories — the shop's own reel ("the process / the result" from
 * @ohmyacai_dues), downloaded once and served locally so it plays reliably on
 * every device. A poster frame extracted from the mp4 shows on load; the play
 * button starts the video and native controls appear from then on. A link back
 * to the reel on Instagram is always visible.
 *
 * The card holds the reel's native 9:16 aspect, capped at 560px wide so the
 * cup portraits stay legible; on desktop it sits centred rather than filling
 * the whole 1320-wide row.
 */
      ...
      <div className="mx-auto w-full max-w-[1320px]">
        ...
        >
          <div className="mx-auto max-w-[420px]">
            <div className="relative aspect-[9/16] w-full overflow-hidden rounded-3xl bg-plum/95 shadow-[0_24px_60px_-24px_rgba(77,41,78,0.5)]">
              <video
                ref={videoRef}
